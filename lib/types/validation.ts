...
export const intakeFormSchema = z.object({
  ...
  training_styles: z.array(z.nativeEnum(TrainingStyle))
  ...
  diet_preferences: z.array(z.nativeEnum(DietPreference))
...
export const exerciseSchema = z.object({
  ...
  target_muscles: z.array(z.string()).min(1, 'At least one target muscle required'),
...
export const workoutCompletionSchema = z.object({
  ...
  completed_exercises: z.array(z.object({
...
export type FitnessAssessmentStepData = z.infer<typeof fitnessAssessmentStepSchema>;

  ...
  const executeAction = async (actionId: string) => {
    ...
    try {
      ...
      switch (actionId) {
        case 'start-workout':
          resultMessage =
            "🏋️ Workout started! I've begun tracking your session. Remember to maintain proper form and stay hydrated!";
          break;
        ...
        case 'take-progress-photo':
          resultMessage =
            '📸 Progress photo captured! Visual progress is incredibly motivating. I can help you compare with previous photos to see your amazing transformation!';
          break;
        ...
        case 'workout-timer':
          resultMessage =
            "⏱️ Workout timer started! I'll track your session duration and help you maintain optimal rest periods between sets. Focus on quality reps!";
          break;
      ...
      onActionComplete(
        '❌ Sorry, I encountered an error while executing that action. Please try again.'
      );
    } finally {
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, weight: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, mealName: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, calories: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, goalTitle: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, goalTarget: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, workoutDate: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setActionData({ ...actionData, workoutType: e.target.value })
                }
              />
            </div>
          </div>

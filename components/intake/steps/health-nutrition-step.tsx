...
const CUISINE_TYPES = [
  ...
  'French', 'Japanese', 'Thai', 'Chinese', 'Greek', 'Middle Eastern',
  'Korean', 'Vietnamese', 'Spanish', 'British', 'German', 'Russian'
];

export function HealthNutritionStep({ data, errors, onChange }: HealthNutritionStepProps) {
  ...
  const handleDietPreferenceChange = (preference: DietPreference, checked: boolean) => {
    let updated = checked
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Please describe any injuries, health conditions, or physical limitations we should consider
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start space-x-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <div className="text-sm text-amber-800">
              ...
              <p className="mt-1">
                This app provides fitness guidance only and cannot replace medical advice. 
                Please consult healthcare professionals for any medical conditions or concerns.
              </p>
            </div>
          </div>
        </div>
        ...
        {errors.injuries_limitations && (
          <p className="text-sm text-destructive">{errors.injuries_limitations}</p>
        )}
      </div>
          ...
          {DIET_PREFERENCES.map((diet) => {
            ...
            return (
              <Card 
                ...
                onClick={() => handleDietPreferenceChange(diet.value, !isSelected)}
              >
                  ...
                  <div className="flex items-start space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleDietPreferenceChange(diet.value, checked as boolean)
                      }
                    />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-muted/50 p-3 rounded-lg">
            <p className="text-sm font-medium mb-2">Common allergies & intolerances:</p>
      ...
      <div className="space-y-4">
        <div>
          <Label className="text-lg font-semibold">Preferred Cuisines (Optional)</Label>
          <p className="text-sm text-muted-foreground mt-1">
        ...
        {selectedCuisines.length > 0 && (
          <div className="bg-primary/5 border border-primary/20 p-3 rounded-lg">
            <p className="text-sm font-medium">Selected cuisines ({selectedCuisines.length}):</p>
            <div className="flex flex-wrap gap-1 mt-2">
      ...
      <div className="bg-primary/5 border border-primary/20 p-4 rounded-lg">
        ...
        <ul className="text-sm space-y-1">
          <li>• <strong>Safety first:</strong> We'll avoid all foods you're allergic to</li>
          <li>• <strong>Dietary preferences:</strong> Meal plans will match your eating style</li>
          <li>• <strong>Cuisine variety:</strong> More preferences = more diverse meal options</li>
          <li>• <strong>Flexible approach:</strong> All preferences can be adjusted later</li>
        </ul>
      </div>
    </div>
  );
